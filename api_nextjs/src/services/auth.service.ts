...
import { JwtPayload, AuthTokens } from "@app-types/auth";
...
export class AuthService {
  ...
  private async generateTokens(user: User): Promise<AuthTokens> {
    ...
    const accessToken = (jwt.sign as any)(payload, process.env.JWT_ACCESS_SECRET!, {
      expiresIn: process.env.JWT_ACCESS_EXPIRES_IN ?? "15m",
    });

    const refreshToken = (jwt.sign as any)(payload, process.env.JWT_REFRESH_SECRET!, {
