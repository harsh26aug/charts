...
import type { NiftyStockRecord } from '../../types/stock';
...
const createDefaultSlots = (): ChartSlot<NiftyStockRecord>[] => {
  const now = new Date();
...
export const NiftyCharts = () => {
  const [charts, setCharts] = useState<ChartSlot<NiftyStockRecord>[]>(createDefaultSlots);
